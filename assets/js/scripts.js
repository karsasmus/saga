...
var siteurl = $('#site-url').attr("href"), // Get url for blog (in case site is run under a sub-domain)
    themeurl = $('#site-url').attr('data-theme-url');
/******************
 * HIGHLIGHT CODE *
 ******************/

if($("code").length !== 0){
    $.getScript(themeurl+"/assets/js/helper/highlight.min.js", function() {
...
$.getScript(themeurl+"/assets/js/helper/jquery.fitvids.js", function() {
    $("#main").fitVids();
});
...
function gallery(){
    $.getScript(themeurl+"/assets/js/helper/gallery.min.js", function() { // Load in script for gallery
        var size = 0;
...
if($("#main").hasClass("content")){
    $.getScript(themeurl+"/assets/js/helper/jquery.fluidbox.min.js", function() {
        $.getScript(themeurl+"/assets/js/helper/imagesloaded.pkgd.min.js", function() {
            function lightBox(){
...
if($("#main").hasClass("archive")){
    $.getScript(themeurl+"/assets/js/helper/masonry.pkgd.min.js", function() {
        $.getScript(themeurl+"/assets/js/helper/imagesloaded.pkgd.min.js", function() {
